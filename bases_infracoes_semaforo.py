...
base = []
with open('bases/bases_tratadas/logradouro_num_semaforo.csv', newline='', encoding='utf-8') as csvfile:
    dados_obj = csv.reader(csvfile, delimiter=',')
    for row in dados_obj:
        base.append(row)
...
joined_tab.to_csv('bases/bases_finalizadas/tab_infracoes_semaforos.csv')