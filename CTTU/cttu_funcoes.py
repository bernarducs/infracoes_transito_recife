...
def formata_log_semaforo(linhas):
    linhas_semaforo = []
    ...
    for linha in linhas:
        ...
        if busca:
            ...
            if busca:
                ...
                linha.extend('logradouro_aproximado')
                if busca:
                    linhas_log_remanescentes.append(linha)
                else:
                    linhas_log_remanescentes.append(logradouro)

    return (linhas_semaforo, linhas_log_com_numero, linhas_log_remanescentes)
