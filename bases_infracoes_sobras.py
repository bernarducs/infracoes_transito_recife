...
""" tabela com infracoes tendo os endereços remanescentes das outras bases """
...
base = []
with open('bases/bases_tratadas/logradouro_aproximado.csv', newline='', encoding='utf-8') as csvfile:
    dados_obj = csv.reader(csvfile, delimiter=',')
    for row in dados_obj:
        base.append(row)
...
with open('bases/bases_finalizadas/tab_infracoes_sobras.csv', 'w', newline='\n') as csvfile:
